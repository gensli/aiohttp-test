...
from socket_server import start_servers
...
if __name__ == '__main__':
    parser = ArgumentParser(description='Aiohttp sandbox socket server')
    parser.add_argument(
        '--sites',
        type=int,
        default=1,
    ...
    logging.info("-- Starting socket server... To exit press CTRL+C")
